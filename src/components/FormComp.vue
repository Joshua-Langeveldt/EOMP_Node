...
<style>
    ...
    .p-3 {
      padding: 1rem !important; /* Adjust padding within the form container */
    }

    .mb-3 {
      margin-bottom: 5% !important; /* Reduce bottom margin between form elements */
    }

    .form-label {
      font-size: small !important; /* Reduce font size of labels for small screens */
      position: relative !important; /* Change position to relative for better alignment */
      margin-left: 0 !important; /* Remove left margin for better alignment on small screens */
    }

    input,
    textarea {
      width: 100% !important; /* Ensure input and textarea take full width */
      margin-top: 1% !important; /* Adjust top margin for better spacing */
    }

    button {
      width: 100% !important; /* Ensure buttons take full width */
      margin-top: 1rem !important; /* Adjust top margin for better spacing */
    }
  }
</style>